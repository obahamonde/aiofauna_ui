...
const items = ref([
  {
    title: 'Docs',
    description: 'Find in-depth information about AioFauna Features and API.',
    href: 'https://docs.aiofauna.com',
  },
  {
    title: 'Learn',
    description: 'Learn about AioFauna in an interactive tutorial.',
    href: 'https://www.youtube.com/watch?v=H3ynnADLP1I',
  },
  {
    title: 'Examples',
    description: 'Discover and deploy awesome AioFauna projects.',
    href: 'https://www.aiofauna.com',
  },
  {
    title: 'AI',
    description: 'Learn how to use AioFauna with AI.',
    href: 'https://swagchain.aiofauna.com',
  },
]);
</script>
<template>
      ...
      <div class="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        <p class="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          ...
          <code class="font-mono font-bold">src/pages/index.vue</code>
        </p>
        <div class="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          <a
            ...
            href="https://obahamonde.aiofauna.com"
            target="_blank"
      ...
      <div class="relative flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px] z-[-1]">
        <img
          class="relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert x4"
          src="/favicon.png"
          alt="App Logo"
          priority
        />
      ...
      <div class="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        <a v-for="action in items" :href="action.href"
